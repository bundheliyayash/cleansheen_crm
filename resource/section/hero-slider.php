...
<section class="hero-slider">
  <div class="slider-container">
    ...
    <div class="slide active">
      <img
        src="<?php echo BASE_URL . '/includes/image/hero-slider-1.png'?>"
    ...
    <div class="slide">
      <img
        src="<?php echo BASE_URL . '/includes/image/hero-slider-2.jpeg'?>"
        alt="Deep Cleaning"
        class="slide-image" />
      <div class="slide-content">
    ...
    <div class="slide">
      <img
        src="<?php echo BASE_URL . '/includes/image/hero-slider-3.jpg'?>"
        alt="Office Cleaning"
        class="slide-image" />
      <div class="slide-content">
