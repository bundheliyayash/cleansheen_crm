    ...
    <div class="container">
        <div class="faq-search">
            <div class="search-box">
                <input type="text" placeholder="Search your question..." id="searchInput">
        ...
        <div class="container">
                ...
                <div class="accordion faq-accordion" id="accordionDomestic">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#domestic1">
                                Do I need to supply any cleaning materials?
                            </button>
                        </h2>
                        <div id="domestic1" class="accordion-collapse collapse" data-bs-parent="#accordionDomestic">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#domestic2">
                                How are payments made?
                            </button>
                        </h2>
                        <div id="domestic2" class="accordion-collapse collapse" data-bs-parent="#accordionDomestic">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#domestic3">
                                How long does the cleaning session take?
                            </button>
                        </h2>
                        <div id="domestic3" class="accordion-collapse collapse" data-bs-parent="#accordionDomestic">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#domestic4">
                                What does your insurance cover?
                            </button>
                        </h2>
                        <div id="domestic4" class="accordion-collapse collapse" data-bs-parent="#accordionDomestic">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#domestic5">
                                Does one-off cleaning sessions include oven cleaning?
                            </button>
                        </h2>
                        <div id="domestic5" class="accordion-collapse collapse" data-bs-parent="#accordionDomestic">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#domestic6">
                                What if I want to cancel the session?
                            </button>
                        </h2>
                        <div id="domestic6" class="accordion-collapse collapse" data-bs-parent="#accordionDomestic">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#domestic7">
                                Should the property be empty of personal belongings?
                            </button>
                        </h2>
                        <div id="domestic7" class="accordion-collapse collapse" data-bs-parent="#accordionDomestic">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#domestic8">
                                Do I need to be at the property during the cleaning?
                            </button>
                        </h2>
                        <div id="domestic8" class="accordion-collapse collapse" data-bs-parent="#accordionDomestic">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#domestic9">
                                How much does the professional One-Off cleaning cost?
                            </button>
                        </h2>
                        <div id="domestic9" class="accordion-collapse collapse" data-bs-parent="#accordionDomestic">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#domestic10">
                                What is the difference between End of Tenancy or Deep Cleaning?
                            </button>
                        </h2>
                        <div id="domestic10" class="accordion-collapse collapse" data-bs-parent="#accordionDomestic">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#domestic11">
                                What if my cleaner is running late?
                            </button>
                        </h2>
                        <div id="domestic11" class="accordion-collapse collapse" data-bs-parent="#accordionDomestic">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#domestic12">
                                What happens if I am not happy with the results?
                            </button>
                        </h2>
                        <div id="domestic12" class="accordion-collapse collapse" data-bs-parent="#accordionDomestic">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#domestic13">
                                Can I clean a room or part of the property?
                            </button>
                        </h2>
                        <div id="domestic13" class="accordion-collapse collapse" data-bs-parent="#accordionDomestic">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#domestic14">
                                What is included in an end of tenancy cleaning?
                            </button>
                        </h2>
                        <div id="domestic14" class="accordion-collapse collapse" data-bs-parent="#accordionDomestic">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#domestic15">
                                What do I need to do before an end of tenancy cleaning or deep cleaning session?
                            </button>
                        </h2>
                        <div id="domestic15" class="accordion-collapse collapse" data-bs-parent="#accordionDomestic">
                            <div class="accordion-body">
                                <ul>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#domestic16">
                                What is the difference between a standard deep clean and pre-baby deep cleaning?
                            </button>
                        </h2>
                        <div id="domestic16" class="accordion-collapse collapse" data-bs-parent="#accordionDomestic">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#domestic17">
                                Do you clean behind or under the heavy furniture or appliances?
                            </button>
                        </h2>
                        <div id="domestic17" class="accordion-collapse collapse" data-bs-parent="#accordionDomestic">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#domestic18">
                                Do you offer decluttering services?
                            </button>
                        </h2>
                        <div id="domestic18" class="accordion-collapse collapse" data-bs-parent="#accordionDomestic">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#domestic19">
                                Is deep cleaning safe for pets and children?
                            </button>
                        </h2>
                        <div id="domestic19" class="accordion-collapse collapse" data-bs-parent="#accordionDomestic">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#domestic20">
                                Can I customise the deep cleaning to focus on specific areas?
                            </button>
                        </h2>
                        <div id="domestic20" class="accordion-collapse collapse" data-bs-parent="#accordionDomestic">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#domestic21">
                                Can you accommodate last-minute bookings for end of tenancy cleaning?
                            </button>
                        </h2>
                        <div id="domestic21" class="accordion-collapse collapse" data-bs-parent="#accordionDomestic">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#domestic22">
                                Do you offer carpet cleaning as part of the end of tenancy service?
                            </button>
                        </h2>
                        <div id="domestic22" class="accordion-collapse collapse" data-bs-parent="#accordionDomestic">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#domestic23">
                                Is parking required for an after-building cleaning service?
                            </button>
                        </h2>
                        <div id="domestic23" class="accordion-collapse collapse" data-bs-parent="#accordionDomestic">
                            <div class="accordion-body">
            ...
            <div id="commercial" class="faq-category">
                ...
                <div class="faq-breadcrumb">
                    <div class="container">
                        <ul class="breadcrumb-list">
                            ...
                            <li><a href="#workhours">Work hours</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="accordion faq-accordion" id="accordionCommercial">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#commercial1">
                                Will the same cleaning operative be attending each time?
                            </button>
                        </h2>
                        <div id="commercial1" class="accordion-collapse collapse" data-bs-parent="#accordionCommercial">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#commercial2">
                                Is the cleaner's attendance monitored? Can you ensure that the working hours are respected?
                            </button>
                        </h2>
                        <div id="commercial2" class="accordion-collapse collapse" data-bs-parent="#accordionCommercial">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#commercial3">
                                What is the minimum duration for a commercial cleaning contract?
                            </button>
                        </h2>
                        <div id="commercial3" class="accordion-collapse collapse" data-bs-parent="#accordionCommercial">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#commercial4">
                                How are the cleaners vetted?
                            </button>
                        </h2>
                        <div id="commercial4" class="accordion-collapse collapse" data-bs-parent="#accordionCommercial">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#commercial5">
                                Are you covering the handover in case of a holiday/illness replacement arrangement?
                            </button>
                        </h2>
                        <div id="commercial5" class="accordion-collapse collapse" data-bs-parent="#accordionCommercial">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#commercial6">
                                What if I don't like a cleaning operative?
                            </button>
                        </h2>
                        <div id="commercial6" class="accordion-collapse collapse" data-bs-parent="#accordionCommercial">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#commercial7">
                                What does your insurance cover?
                            </button>
                        </h2>
                        <div id="commercial7" class="accordion-collapse collapse" data-bs-parent="#accordionCommercial">
                            <div class="accordion-body">
                                Damage to your property caused by the cleaner, theft by the cleaner, key and lock replacement and personal injury to the cleaner.
                            </div>
                        </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#commercial8">
                                Do the extra sessions come at a higher rate?
                            </button>
                        </h2>
                        <div id="commercial8" class="accordion-collapse collapse" data-bs-parent="#accordionCommercial">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#commercial9">
                                What if I want to cancel the session?
                            </button>
                        </h2>
                        <div id="commercial9" class="accordion-collapse collapse" data-bs-parent="#accordionCommercial">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#commercial10">
                                Can we increase/decrease the hours during the length of the contract?
                            </button>
                        </h2>
                        <div id="commercial10" class="accordion-collapse collapse" data-bs-parent="#accordionCommercial">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#commercial11">
                                Do your cleaners work at night?
                            </button>
                        </h2>
                        <div id="commercial11" class="accordion-collapse collapse" data-bs-parent="#accordionCommercial">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#commercial12">
                                What are the benefits of hiring a professional commercial cleaning service?
                            </button>
                        </h2>
                        <div id="commercial12" class="accordion-collapse collapse" data-bs-parent="#accordionCommercial">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#commercial13">
                                Do commercial cleaning services offer emergency or last-minute cleaning options?
                            </button>
                        </h2>
                        <div id="commercial13" class="accordion-collapse collapse" data-bs-parent="#accordionCommercial">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#commercial14">
                                Can I request a different cleaner if I am not satisfied with the current one?
                            </button>
                        </h2>
                        <div id="commercial14" class="accordion-collapse collapse" data-bs-parent="#accordionCommercial">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#commercial15">
                                Have your cleaners been checked for a criminal record (Police Verification)?
                            </button>
                        </h2>
                        <div id="commercial15" class="accordion-collapse collapse" data-bs-parent="#accordionCommercial">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#commercial16">
                                Can I have the service fortnightly?
                            </button>
                        </h2>
                        <div id="commercial16" class="accordion-collapse collapse" data-bs-parent="#accordionCommercial">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#commercial17">
                                Can I ask my cleaner to clean extra rooms if needed?
                            </button>
                        </h2>
                        <div id="commercial17" class="accordion-collapse collapse" data-bs-parent="#accordionCommercial">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#commercial18">
                                Can you clean a small office?
                            </button>
                        </h2>
                        <div id="commercial18" class="accordion-collapse collapse" data-bs-parent="#accordionCommercial">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#commercial19">
                                Do you provide cleaning on weekends?
                            </button>
                        </h2>
                        <div id="commercial19" class="accordion-collapse collapse" data-bs-parent="#accordionCommercial">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#commercial20">
                                How often should I have my office cleaned?
                            </button>
                        </h2>
                        <div id="commercial20" class="accordion-collapse collapse" data-bs-parent="#accordionCommercial">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#commercial21">
                                Is your company insured? What if there is damage to the property after cleaning?
                            </button>
                        </h2>
                        <div id="commercial21" class="accordion-collapse collapse" data-bs-parent="#accordionCommercial">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#commercial22">
                                Does the price include cleaning supplies?
                            </button>
                        </h2>
                        <div id="commercial22" class="accordion-collapse collapse" data-bs-parent="#accordionCommercial">
                            <div class="accordion-body">
