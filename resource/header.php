                        ...
                        <li>
                                ...
                                <ul class="submenu">
                                        <li><a href="<?php echo BASE_URL . 'resource/commercial/office-clean.php'; ?>">Regular Office
                                                        Cleaning</a></li>
                                        <li><a href="<?php echo BASE_URL . 'resource/commercial/deep-clean.php' ?> ">Office Deep
                                                        Cleaning</a></li>
                                        <li><a href="<?php echo BASE_URL . 'resource/commercial/retail-clean.php' ?> ">Retail Cleaning
                                                        Services</a></li>
                                        ...
                                        <li><a href="<?php echo BASE_URL . 'resource/commercial/school-clean.php' ?> ">School Cleaning
                                                        Services</a></li>
                                        <li><a href="<?php echo BASE_URL . 'resource/commercial/warehouse-clean.php' ?> ">Warehouse
                                                        Cleaning</a></li>
                                        ...
                                        <li><a href="<?php echo BASE_URL . 'resource/commercial/washroom-clean.php' ?> ">Washroom
                                                        Services</a></li>
                                        <li><a href="<?php echo BASE_URL . 'resource/commercial/club-house-clean.php' ?> ">Club House Cleaning</a></li>
                                        <li><a href="<?php echo BASE_URL . 'resource/commercial/hotels-resort-clean.php' ?> ">Hotels & Resort Cleaning</a></li>
                                        <li><a href="<?php echo BASE_URL . 'resource/commercial/studio-apartment.php' ?> ">Studio Apartment Cleaning</a></li>
                                        <li><a href="<?php echo BASE_URL . 'resource/commercial/game-zone-clean.php' ?> ">Game Zone Cleaning</a></li>
                                        <li><a href="<?php echo BASE_URL . 'resource/commercial/com-carpet-clean.php' ?> ">Commercial Carpet Cleaning</a></li>
                                </ul>
                        </li>
                        <li>
                                <a href="#">Domestic</a>
                                <ul class="submenu">
                                        <li><a href="<?php echo BASE_URL . 'resource/domestic/domestic-clean.php ' ?>">Regular Domestic
                                                        Cleaning</a></li>
                                        <li><a href="<?php echo BASE_URL . 'resource/domestic/tenancy-clean.php ' ?>">End of Tenancy
                                                        Cleaning</a></li>
                                        <li><a href="<?php echo BASE_URL . 'resource/domestic/deep-clean.php ' ?>">Deep Cleaning</a></li>
                                        <li><a href="<?php echo BASE_URL . 'resource/domestic/dom-carpet-clean.php ' ?>">Carpet Cleaning</a>
                                        </li>
                                        ...
                                        <li><a href="<?php echo BASE_URL . 'resource/domestic/eco-friendly-clean.php ' ?>">Eco-Friendly
                                                        Cleaning</a></li>
                                        <li><a href="<?php echo BASE_URL . 'resource/domestic/one-off-clean.php ' ?>">One Off Cleaning
                                                        Service</a></li>
                                        <li><a href="<?php echo BASE_URL . 'resource/domestic/housekeeping-clean.php ' ?>">Housekeeping
                                                        Services</a></li>
                                        <!-- <li><a href="<? //php echo BASE_URL . 'resource/domestic/ironing-service.php '
                                                                ?>">Ironing Services</a></li> -->
                                        <!-- <li><a href="<? //php echo BASE_URL . 'resource/domestic/upholstery-clean.php ' 
                                                                ?>">Upholstery
                        Cleaning</a>
                </li> -->
                                        <!-- <li><a href="<? //php echo BASE_URL . 'resource/domestic/mattress-clean.php ' 
                                                                ?>">Mattress Cleaning</a> -->
                                        <!-- </li> -->
                                </ul>
                        </li>
                                ...
                                <ul class="submenu">
                                        ...
                                        <li>
                                                ...
                                                <ul class="ssubmenu">
                                                        ...
                                                        <li><a href="<?php echo BASE_URL . 'resource/customers/estate-agent.php' ?>">Estate Agents</a></li>
                                                        <li><a href="<?php echo BASE_URL . 'resource/customers/property-management-com.php' ?>">Property Management Companies</a></li>
                                                        <li><a href="<?php echo BASE_URL . 'resource/customers/cooperative-housing.php' ?>">Co-operative Housing Societies</a></li>
                                                        <li><a href="<?php echo BASE_URL . 'resource/customers/banks.php' ?>">Banks & Financial Institutions</a></li>
                                                </ul>
                                        </li>
                                        ...
                                        <li>
                                                <a href="#">Education</a>
                                                <ul class="ssubmenu">
                                                        <li><a href="<?php echo BASE_URL . 'resource/customers/education-school.php' ?>">Schools</a></li>
                                                        <li><a href="<?php echo BASE_URL . 'resource/customers/education-college.php' ?>">Colleges</a></li>
                                                        <li><a href="<?php echo BASE_URL . 'resource/customers/education-institute.php' ?>">Institutes & Training Centers</a></li>
                                                </ul>
                                        </li>

                                        <!-- Hospitality & Food -->
                                        <li>
                                                <a href="#">Hospitality & Food</a>
                                                <ul class="ssubmenu">
                                                        <li><a href="<?php echo BASE_URL . 'resource/customers/hotels.php' ?>">Hotels</a></li>
                                                        <li><a href="<?php echo BASE_URL . 'resource/customers/resorts.php' ?>">Resorts</a></li>
                                                        <li><a href="<?php echo BASE_URL . 'resource/customers/bars-restaurants.php' ?>">Restaurants & Cafés</a></li>
                                                        <li><a href="<?php echo BASE_URL . 'resource/customers/food-chains.php' ?>">Food Chains & Franchises</a></li>
                                                </ul>
                                        </li>
                                        ...
                                        <li>
                                                <a href="#">Healthcare</a>
                                                <ul class="ssubmenu">
                                                        <li><a href="<?php echo BASE_URL . 'resource/customers/medical-org.php' ?>">Hospitals</a></li>
                                                        <li><a href="<?php echo BASE_URL . 'resource/customers/clinics.php' ?>">Clinics</a></li>
                                                        <li><a href="<?php echo BASE_URL . 'resource/customers/medical-org.php' ?>">Medical Organisations</a></li>
                                                </ul>
                                        </li>
                                        ...
                                        <!-- Retail -->
                                        <li>
                                                <a href="#">Retail & Public Spaces</a>
                                                <ul class="ssubmenu">
                                                        <li><a href="<?php echo BASE_URL . 'resource/customers/retail-showrooms.php' ?>">Retail Stores</a></li>
                                                        <li><a href="<?php echo BASE_URL . 'resource/customers/showrooms.php' ?>">Showrooms</a></li>
                                                </ul>
                                        </li>
                                        ...
                                        <li>
                                                ...
                                                <ul class="ssubmenu">
                                                        <li><a href="<?php echo BASE_URL . 'resource/customers/architect-project.php' ?>">Architect Projects</a></li>
                                                        <li><a href="<?php echo BASE_URL . 'resource/customers/project-management.php' ?>">Project Management</a></li>
                                                </ul>
                                        </li>
                                        ...
                                        <li>
                                                ...
                                                <ul class="ssubmenu">
                                                        <li><a href="<?php echo BASE_URL . 'resource/customers/government-institute.php' ?>">Government Institutes</a></li>
                                                        <li><a href="<?php echo BASE_URL . 'resource/customers/embassies.php' ?>">Embassies</a></li>
                                                </ul>
                                        </li>
