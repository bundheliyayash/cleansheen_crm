            ...
            <li>
                ...
                <ul class="submenu">
                    ...
                    <li><a href="<?php echo BASE_URL . 'resource/commercial/washroom-clean.php' ?> ">Washroom
                            Services</a></li>
                    <li><a href="<?php echo BASE_URL . 'resource/commercial/club-house-clean.php' ?> ">Club House
                            Cleaning</a></li>
                    <li><a href="<?php echo BASE_URL . 'resource/commercial/hotels-resort-clean.php' ?> ">Hotels &
                            Resort Cleaning</a></li>
                    <li><a href="<?php echo BASE_URL . 'resource/commercial/studio-apartment.php' ?> ">Studio Apartment
                            Cleaning</a></li>
                    <li><a href="<?php echo BASE_URL . 'resource/commercial/game-zone-clean.php' ?> ">Game Zone
                            Cleaning</a></li>
                    <li><a href="<?php echo BASE_URL . 'resource/commercial/com-carpet-clean.php' ?> ">Commercial Carpet
                            Cleaning</a></li>
                </ul>
            </li>
            <li>
            ...
            <li>
                ...
                <ul class="submenu">
                    ...
                    <li>
                        ...
                        <ul class="ssubmenu">
                            ...
                            <li><a href="<?php echo BASE_URL . 'resource/customers/industrial-com.php' ?>">Industrial
                                    Companies</a></li>
                            <li><a href="<?php echo BASE_URL . 'resource/customers/estate-agent.php' ?>">Estate
                                    Agents</a></li>
                            <li><a href="<?php echo BASE_URL . 'resource/customers/property-management-com.php' ?>">Property
                                    Management Companies</a></li>
                            <li><a href="<?php echo BASE_URL . 'resource/customers/cooperative-housing.php' ?>">Co-operative
                                    Housing Societies</a></li>
                            <li><a href="<?php echo BASE_URL . 'resource/customers/banks.php' ?>">Banks & Financial
                                    Institutions</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="#">Education</a>
                        <ul class="ssubmenu">
                            <li><a href="<?php echo BASE_URL . 'resource/customers/education-school.php' ?>">Schools</a>
                            </li>
                            <li><a
                                    href="<?php echo BASE_URL . 'resource/customers/education-college.php' ?>">Colleges</a>
                            </li>
                            <li><a href="<?php echo BASE_URL . 'resource/customers/education-institute.php' ?>">Institutes
                                    & Training Centers</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="ssubmenu">
                            ...
                            <li><a href="<?php echo BASE_URL . 'resource/customers/cafe-restaurants.php' ?>">Restaurants
                                    & Cafés</a></li>
                            <li><a href="<?php echo BASE_URL . 'resource/customers/food-chains.php' ?>">Food Chains &
                                    Franchises</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="#">Healthcare</a>
                        <ul class="ssubmenu">
                            <li><a href="<?php echo BASE_URL . 'resource/customers/hospital.php' ?>">Hospitals</a>
                            </li>
                            <li><a href="<?php echo BASE_URL . 'resource/customers/clinics.php' ?>">Clinics</a></li>
                            <li><a href="<?php echo BASE_URL . 'resource/customers/medical-org.php' ?>">Medical
                                    Organisations</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="ssubmenu">
                            <li><a href="<?php echo BASE_URL . 'resource/customers/retail-showrooms.php' ?>">Retail
                                    Stores</a></li>
                    ...
                    <li>
                        ...
                        <ul class="ssubmenu">
                            <li><a href="<?php echo BASE_URL . 'resource/customers/government-institute.php' ?>">Government
                                    Institutes</a></li>
                            <li><a href="<?php echo BASE_URL . 'resource/customers/embassies.php' ?>">Embassies</a></li>
                        </ul>
                    </li>
